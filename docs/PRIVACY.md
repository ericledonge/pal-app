...
L'application ne collecte **aucune donnée personnelle identifiante**. Si les outils de mesure sont activés dans la version distribuée, sont traitées :

- **Rapports de plantage et de performance** (Sentry) — pour diagnostiquer les erreurs (incluant des informations techniques sur l'appareil et la version de l'app). Non liés à votre identité.
- **Statistiques d'utilisation** (Amplitude) — événements d'usage anonymes et un identifiant d'appareil, pour comprendre quelles fonctions sont utilisées. Non liés à votre identité, sans suivi publicitaire.

Ces données ne sont **ni vendues, ni partagées** à des fins publicitaires.
...
Pour toute question : **eric.ledonge@pm.me**.
