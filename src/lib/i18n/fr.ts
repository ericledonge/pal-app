...
export const fr = {
  ...
  matrix: {
    ...
    sessionEmpty: "Aucune session en cours ou à venir.",
    ...
    terrains: "Terrains",
    matchDuration: "Durée d'un match",
    ...
    notifBody: "La ronde est terminée. Touchez pour revenir au minuteur.",
    round: "Ronde",
    ...
    increaseDuration: "Augmenter la durée d'un match",
